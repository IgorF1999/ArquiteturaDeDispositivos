...
public class RemoteConsole extends javax.swing.JFrame {
    ...
    private static final String eventHubsCompatibleEndpoint = "sb://ihsuprodamres041dednamespace.servicebus.windows.net/";

    // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
    private static final String eventHubsCompatiblePath = "iothub-ehub-smarttermo-2569719-b65721b3f8";

    // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
    private static final String iotHubSasKey = "S5PL9N0WNNkVAozRTNKHkGSJkvLfGX0xD7b+XARMmR8=";
